...
-- Records of admins
-- ----------------------------
INSERT INTO `admins` VALUES ('sst', 'Um1kRUwwdEE=N2RhZGM4MjhlNGFmMzkzNGIyZWUyYWVlMGE4MzNhMGU=', '00000001', 'kJBvoRlojjmdkuZl', 1);
...
INSERT INTO `shetuan` VALUES ('00000023', '三农发展研究会', '三农发展研究会协会会徽以蓝色背景与河大校徽相呼应，两者都是蓝色，其次双手对立罩在三片叶子之上喻有呵护，保护的意思，同时双手也代表着“人”，是对我们人的一种期望，希望作为“人”的我们人去关注三农，为三农做些贡献。手下的三片叶子代表三农（农业，农村，农民）它们三者的颜色都不一样，绿色代表生命，活力，希望，所以它们三个的基色是绿色，但是最上面的那个叶子是黄绿（刚发芽，脆弱）左下深绿色，右下橄榄绿，两者差不多，会有一些小小的差别，2003是社团成立的时间，其中河南大学三农发展研究会几个字顺着圆的形状去写，把农字放中间，河跟会是对齐的。', '/images/commLogo/none.png', 180, 0, '学术科技', 1, '未设置', '河南大学马克思主义学院', 'NULL', '寒暑假下乡活动、周边共建项目活动、支农社团交流会 ', 'NULL', '明伦');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('oOj6Z5YYn2ECqt7zUWrs017TcxCU', 'zAEOGPTvELBfEQ4FQv9Lxw==', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
